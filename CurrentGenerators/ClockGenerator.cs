...
namespace Emulators
{
	...
	public class ClockGenerator : ICurrentGenerator
	{
		...
		public async Task ExecuteAsync(CancellationToken ct)
		{
			...
			{
				CurrentPhase = CLOCK_GENERATOR_PHASE.HightVoltagePhase;
				CurrentLevel_Volt = this.HighLevel_Volt;
				await Task.Delay((int)(this.HighLevelDuration_sec * 1000));

				CurrentPhase = CLOCK_GENERATOR_PHASE.LowVoltagePhase;
				CurrentLevel_Volt = this.LowLevel_Volt; ;
